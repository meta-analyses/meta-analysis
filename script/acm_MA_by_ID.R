...
for (uid in unique(acm$id)){ 
  ...
  rr_conf <- data.frame(outcome = "All-cause cancer", id = uid, lowest_guideline = rr_df[1],
                        lowest_CFI = paste0("(",lb_df[1], " - ", ub_df[1], ")"), mid_guideline = rr_df[2],
                        mid_CFI = paste0("(", lb_df[2], " - ", ub_df[2], ")"), mid_lb=lb_df[2], mid_ub=ub_df[2],
                        highest_guideline = rr_df[3],
                        highest_CFI = paste0("(", lb_df[3], " - ", ub_df[3], ")"))
...
for (uid in unique(acm$id)){ 
  ...
  rr_conf <- data.frame(outcome = "All-cause cvd", id = uid, lowest_guideline = rr_df[1],
                        lowest_CFI = paste0("(",lb_df[1], " - ", ub_df[1], ")"), mid_guideline = rr_df[2],
                        mid_CFI = paste0("(", lb_df[2], " - ", ub_df[2], ")"), mid_lb=lb_df[2], mid_ub=ub_df[2],
                        highest_guideline = rr_df[3],
                        highest_CFI = paste0("(", lb_df[3], " - ", ub_df[3], ")"))
...
for (uid in unique(acm$id)){ 
  ...
  rr_conf <- data.frame(outcome = "All-cause dementia", id = uid, lowest_guideline = rr_df[1],
                        lowest_CFI = paste0("(",lb_df[1], " - ", ub_df[1], ")"), mid_guideline = rr_df[2],
                        mid_CFI = paste0("(", lb_df[2], " - ", ub_df[2], ")"), mid_lb=lb_df[2], mid_ub=ub_df[2],
                        highest_guideline = rr_df[3],
                        highest_CFI = paste0("(", lb_df[3], " - ", ub_df[3], ")"))
